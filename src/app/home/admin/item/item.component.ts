...
export class ItemComponent {
    ...
    ngOnInit() {
        this.i_service
            .listItem(this.order, this.sortBy, this.pageSize, this.pageNumber, this.keySearch)
            .subscribe((data: any) => {
    ...
    validateForm(): boolean {
        ...
        // Validate số nguyên
        if (
            !this.itemForm.displayOrder ||
            !Number.isInteger(this.itemForm.displayOrder) ||
            this.itemForm.displayOrder <= 0
        ) {
